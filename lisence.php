...
// Hash password yang disimpan (gunakan bcrypt atau algoritma lain yang aman)
$hashed_password = '$2a$12$tCBBi9Qk1n3UTs3vxei.n.jFE2TN5SzCEyVG3GLam4yrqkRsqyA0q'; // Hash dari "my_password"

// Memeriksa apakah sesi login sudah ada
if (!isset($_SESSION['loggedin'])) {
    // Cek apakah ada input password dari form
    if (isset($_POST['password'])) {
        // Memeriksa apakah password yang dimasukkan sesuai dengan hash
        if (password_verify($_POST['password'], $hashed_password)) {
            $_SESSION['loggedin'] = true; // Set sesi sebagai logged in
        } else {
            echo "Password salah!";
        }
    }

    // Jika sesi belum ada atau password salah, tampilkan form password
    if (!isset($_SESSION['loggedin'])) {
        echo '
        <form method="post">
        ...
        exit; // Hentikan eksekusi kode lebih lanjut sampai password benar
    }
}
